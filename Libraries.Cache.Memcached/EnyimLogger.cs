...
{
	public class EnyimLogger : ILog
	{
		private readonly ILog _serviceStackLogger;

		public EnyimLogger(ILog serviceStackLogger)
		{
		...
		public bool IsDebugEnabled
		{
			get
			{
				return _serviceStackLogger.IsDebugEnabled;
			}
		}
		...
		{
			_serviceStackLogger.DebugFormat(format, new object[]
			{
				arg0
			});
		}
		...
		{
			_serviceStackLogger.InfoFormat(format, new object[]
			{
				arg0
			});
		}
		...
		{
			_serviceStackLogger.WarnFormat(format, new object[]
			{
				arg0
			});
		}
		...
		{
			_serviceStackLogger.ErrorFormat(format, new object[]
			{
				arg0
			});
		}
		...
		{
			_serviceStackLogger.FatalFormat(format, new object[]
			{
				arg0
			});
		}
